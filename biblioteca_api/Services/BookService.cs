...
namespace biblioteca_api.Services
{
    public class BookService : IBookService
    {
        ...
        public async Task<BookDTO> Create(CreateBookDTO bookDto)
        {
            ...
            var author = await _context.Authors.FindAsync(bookDto.AuthorEntityId)
            ...
            var supplier = await _context.Suppliers.FindAsync(bookDto.SupplierId)
            ...
            var book = new Book
            {
                Title = bookDto.Title,
                Author = author.Name,
                AuthorEntityId = bookDto.AuthorEntityId,
