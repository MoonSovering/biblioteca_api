...
namespace biblioteca_api.Services
{
    public class LoanService : ILoanService
    {
        ...
        public async Task<Loan> BorrowBook(int bookId, int userId)
        {
        ...
        public async Task RenewLoan(int loanId)
        {
        ...
        public async Task<IEnumerable<Loan>> GetLoansByDateRange(DateTime startDate, DateTime endDate)
        {
            return await _context.Loans
                .Include(l => l.Book)
                .Include(l => l.User)
